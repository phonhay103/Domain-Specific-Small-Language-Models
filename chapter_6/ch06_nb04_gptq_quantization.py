...
def main() -> None:
    ...
    with status_spinner(f"Loading '{MODEL_ID}' base weights..."):
        model = GPTQModel.from_pretrained(MODEL_ID, quantize_config=quantize_config)
    ...
    with status_spinner("Loading 4-bit model onto GPU and running generation..."):
        quantized_model = GPTQModel.from_quantized(QUANTIZED_MODEL_DIR, device=CUDA_DEVICE)
